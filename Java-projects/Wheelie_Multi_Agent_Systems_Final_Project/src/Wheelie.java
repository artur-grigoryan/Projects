...
public class Wheelie {
	...
	// the graph of the world, which is initialized in the function setUp
		...
		// an array of links in the world
		...
		//the linkWeights array is for keeping the average loads for each link in the world
		//payouts array is for keeping the payout agent got during last traverse of the link, 0 by default
		...
		//prevLink and prevNode are for keeping information about previous trip
		static int prevNode;
		static int prevLink;
		//averageLoad 1 is the average load for the link 0, averageLoad2 is the average load for link 1
		//average load are taken from the linkWeights array on each node.
		static double averageLoad1 = 0;
		static double averageLoad2 = 0;
		static double previousLoad = 0;
		//payouts of agent if he went through link 0 and 1, respectively
